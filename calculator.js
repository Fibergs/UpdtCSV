...
class PlasticCalculator {
    constructor() {
        ...
        // Current slider values — start at 0 to match UI initial state
        this.inputs = {
            bins_woodsafe: 0,
            bins_reduce: 0,
            gloves_replace: 0,
    ...
    calculate() {
        ...
        return {
            ...
            totals: {
                ...
                carbon_by_category: {
                    bins: binsSaved * co2.bins,
                    gloves: glovesSaved * co2.gloves,
                    pipettes: pipettesSaved * co2.pipettes,
                    tubes: tubesSaved * co2.tubes,
                    cell_culture: cultureSaved * co2.cell_culture
                },
                cost_reduction_percent: cost_reduction_percent,
                bins_cost_chg: bins_cost_chg * 100,
                gloves_cost_chg: gloves_cost_chg * 100,
